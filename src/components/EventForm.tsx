  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-700">
        Submit up to 4 events to the community calendar
      </p>

      <Alert className="border-blue-500 bg-blue-50">
        <AlertTitle>📤 How it works</AlertTitle>
        <AlertDescription>
          Fill out the event details below and click "Submit Events" to
          automatically create a GitHub Pull Request.
          <br />
          <strong>New events:</strong> Leave ID field empty |{" "}
          <strong>Update existing:</strong> Enter the event ID without #
        </AlertDescription>
      </Alert>
